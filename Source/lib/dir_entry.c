...
PUBLIC void enter_dir_entry(const char *pathname)
{
	MESSAGE msg;
...
PUBLIC void back_dir_entry(const char *pathname)
{
	MESSAGE msg;
...
PUBLIC bool delete_dir_entry(const char *pathname)
{
	MESSAGE msg;
...
PUBLIC bool move_dir_entry(const char *pathname, const char *pathname_to)
{
	MESSAGE msg;
